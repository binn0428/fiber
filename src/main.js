...
async function confirmAutoAdd() {
    ...
    try {
        const historyData = {
            path_id: pathId,
            start_node: path.originalStart,
            end_node: path.originalEnd,
            nodes: path.nodes, // Supabase handles array/jsonb automatically usually, or we stringify if text
            usage: updates.usage,
        ...
        // Assuming JSONB or Text. Let's try passing as is, if fails we fix.
